                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                ...
                                                <div class="card project-task">
                                                    <div class="page-body">
                                        <div class="card card1 card_red float-right" style="margin-top: 20px; margin-right: 20px;">
                                            <a data-toggle="modal" data-target="#addCenter"> <i class="icofont icofont-user card1-icon" style="font-size: large;"></i> &nbsp;Register</a>
                                          </div>
