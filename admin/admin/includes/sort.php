...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (isset($_POST['hidden_action'])){
        ...
        if ($countR > 0) {
            ...
            if ($countRin > 0) {
               ...
               $showPop = "<div class='alert alert-danger' role='alert'>
                ...
                $insert0 = $allo->query("INSERT INTO admin_center(`center_name`, `center_location`, `center_id`) VALUES ('{$centerName}','{$lName}','{$r_a}')") or die(mysqli_error($allo));
            ...
            $insert0 = $allo->query("INSERT INTO admin_center(`center_name`, `center_location`, `center_id`) VALUES ('{$centerName}','{$lName}','CENTER-1')") or die(mysqli_error($allo));
       ...
       $countR1 = mysqli_fetch_assoc($insert01);
        ...
        $insert01 = $allo->query("SELECT * FROM access_students  ORDER BY s_id DESC") or die(mysqli_error($allo));
       ...
       $countR1 = mysqli_fetch_assoc($insert01);
        ...
        if ($countR > 0) {
            ...
            $insert0 = $allo->query("INSERT INTO access_students(`fullname`, `s_trackId`, `s_lastSeen`, `s_password`, `homeTown`, `img`, `center_id`) VALUES ('{$fname}','AFH-2020-1', '','{$password}','{$town}','','{$center}')") or die(mysqli_error($allo));
